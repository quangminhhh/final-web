...
<div class="site-wrap">
    ...
    <div class="site-blocks-cover" style="background-image: url(static/images/bg-4.jpg);" data-aos="fade">
        <div class="container">
            <div class="row align-items-start align-items-md-center justify-content-start">
                <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
                    <h1 class="mb-2">Finding Your Perfect Books</h1>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md-12 col-lg-7 mb-5">
                    <a href="#"><img src="static/images/blog_2.jpg" alt="Image placeholder"
